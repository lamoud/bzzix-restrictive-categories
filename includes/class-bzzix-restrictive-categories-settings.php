...
class bzzix_restrictive_categories_Settings {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cloning of bzzix_restrictive_categories_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __clone()
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Unserializing instances of bzzix_restrictive_categories_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __wakeup()
