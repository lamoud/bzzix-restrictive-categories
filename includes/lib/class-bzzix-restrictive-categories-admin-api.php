 ...
 * Admin API class.
 */
class bzzix_restrictive_categories_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'bzzix-restrictive-categories' ) . '" data-uploader_button_text="' . __( 'Use image', 'bzzix-restrictive-categories' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'bzzix-restrictive-categories' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'bzzix-restrictive-categories' ) . '" />' . "\n";
